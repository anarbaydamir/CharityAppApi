...
@RestController
@RequestMapping("/searchingGoods")
public class SearchingGoodsPhotosRestController {

    @Autowired
    private UploadImageServiceInter uploadImageServiceInter;
    ...
    public ResponseEntity uploadImage(@RequestParam("image") MultipartFile image,
        ...
        if (result)
            return ResponseEntity.ok().body(new ResponseDto("ok",uploadImageServiceInter.getImageDirList("searchingGoods",dir,id)));
        else
    ...
    private String dirCreator(Integer id){
        return String.format("/Users/anarbaydamirov/Desktop/ITway/PROD/charity/files/searchinggoods/%s",id);
    }
}
